...
const LabelWithIcon = ({label, showLabel, otherName}) => {
    ...
    return (  
            ...
            ? 
                ...
                :
                    label == 'Innovations' || label == 'Innovation'  || label == 'Owned' || (typeof otherName != 'undefined' && (label == 'Invented' || label == 'Acquired' || label == 'Maintenance Fee Due' || label == 'Abandoned' || label == 'Chain-of-Title' || label == 'To Divest'))? 

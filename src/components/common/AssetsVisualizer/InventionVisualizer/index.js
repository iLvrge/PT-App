                ...
                showContainer === true && (
                    <React.Fragment>  
                        ...
                        } 
                        {
                            selectedTab === 0 && (
                                <React.Fragment>  
                                    <TitleBar title={`Hover over the bars for details. Select a bar to see the list of the underlying patents, and to act upon them. Click the menu icon to filter the results.`} enablePadding={typeof titleBar !== 'undefined' && titleBar === true ? false : true} underline={false} typography={true} relative={true}/>
                                </React.Fragment>
                            )
                        } 
                        {
                        ...
                        <span className={classes.settingContainer} ref={settingRef}>
                            <IconButton onClick={(event) => dashboardScreen === true ? toggleDrawer(event, true) :  handleOpenFilter()} className={classes.btnSetting} /* className={clsx(classes.settingBtn, {[classes.settingBtnTop]: typeof middle !== 'undefined' && middle === true ? true : false})} */ size="large">

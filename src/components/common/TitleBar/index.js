                ...
                }
                {
                    typeof props.button != 'undefined' && (
                        <span style={{display: 'block'}}>
                            <IconButton onClick={(event) => props.button.dashboardScreen === true ? props.button.click(event, true) :  props.button.click()} className={clsx(props.button.class)} /* className={clsx(classes.settingBtn, {[classes.settingBtnTop]: typeof middle !== 'undefined' && middle === true ? true : false})} */ size="large">

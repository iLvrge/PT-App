    ...
    return (
        ...
        >         
            <div style={{display: 'unset'}}>   
                ...
                {
                    illustrationBar === true && ( typeof cube == 'undefined' || (typeof cube !== 'undefined' && cube === false) || ((maintainence  === true || record === true) && assetIllustration === null))  && dashboardScreen === false && !isFullscreenOpen && shouldShowTimeline === true || (['collaterlized','deflated_collaterals'].includes(selectedCategory) && shouldShowTimeline === true)
                    ?
                        <IconButton 
                            size="small" 
                ...
                {  
                    ...
                    ?
                        ...
                        ?
                            ...
                            :
                                ['deflated_collaterals', 'collaterlized'].includes(selectedCategory)  ?
                                    <TimelineWithLogo 
                            ...
                            ['clear_encumbrances'].includes(selectedCategory)?
                                <TimelineContainer 
                                    assignmentBar={assignmentBar} 
                                    assignmentBarToggle={assignmentBarToggle} 
                                    type={type}

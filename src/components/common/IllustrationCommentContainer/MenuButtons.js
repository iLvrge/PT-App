    ...
    return (
        <div className={'pt-header-container'}>
            <IconButton
                ...
                className={`${'pt-button-menu'} ${type == 'technology' ? 'pt-illustration-active' : ''}`}
                size="large">
            ...
            <IconButton
                ...
                className={`${'pt-button-menu'} ${type == 'products' ? 'pt-illustration-active' : ''}`}
                size="large">
            ...
            <IconButton
                ...
                className={`${'pt-button-menu'} ${type == 'competitors' ? 'pt-illustration-active' : ''}`}
                size="large">

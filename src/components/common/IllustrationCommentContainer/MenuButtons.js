    ...
    return (
        <div className={classes.headerContainer}>
            <IconButton
                ...
                className={`${classes.buttonMenu} ${type == 'technology' ? classes.active : ''}`}
                size="large">
            ...
            <IconButton
                ...
                className={`${classes.buttonMenu} ${type == 'products' ? classes.active : ''}`}
                size="large">
            ...
            <IconButton
                ...
                className={`${classes.buttonMenu} ${type == 'competitors' ? classes.active : ''}`}
                size="large">

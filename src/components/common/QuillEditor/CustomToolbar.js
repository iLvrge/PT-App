...
import { IconButton, Tooltip, Typography, Zoom, Button, CircularProgress }  from '@material-ui/core'
    ...
    <div id='toolbar' ref={toolBarRef}>
     ...
     {/*  <Tooltip title="Bold" arrow classes={classesTooltip}>
      ...
      <Tooltip 
        ...
        <IconButton onClick={onUserClick} className={'ql-atButton'}>
          <AtButton />
        </IconButton>
      </Tooltip> 
      ...
      >
        <IconButton onClick={onAttachmentOpenedFile} className={'ql-attachButton'}>
      ...
      <Tooltip 
        ...
        arrow classes={classesTooltip}>
        <IconButton onClick={onAttachmentOpenedFileAndEmail} className={'ql-attachButton'}>
      ...
      <Tooltip 
        ...
        arrow classes={classesTooltip}>
        <IconButton onClick={onAttachmentFile} className={'ql-attachButton'}>
          <AttachButton /> 
        </IconButton>
      </Tooltip>
      ...
      <Tooltip 
        ...
        arrow classes={classesTooltip}>
        <IconButton className={'ql-attachButton ql-attachDriveButton'} onClick={onAttachmentDriveFile}>
      ...
      <Tooltip 
        ...
        arrow classes={classesTooltip}>
        <IconButton className={'ql-saveButton'} onClick={onClick}>
          <SendIcon />   
        </IconButton> 
      </Tooltip>     
      ...
      <Tooltip 
        ...
        classes={classesTooltip}>
        <IconButton className={classes.share} onClick={onShare} >
          <FontAwesomeIcon
            icon={faShareAlt}
          />
        </IconButton>

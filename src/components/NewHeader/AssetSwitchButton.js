      ...
      <React.Fragment>
        {
          process.env.REACT_APP_ENVIROMENT_MODE === 'PRO' && (
            <MenuItem onClick={props.click} className={`iconItem`}  /* selected={(props.category === 'due_dilligence' || props.category === 'restore_ownership') && !props.display_sales_assets} */>              <ListItemIcon>
                {

        ...
        <React.Fragment>
            ...
            >
                <span>
                    <IconButton 
                        ...
                        onClick={() => process.env.REACT_APP_ENVIROMENT_MODE === 'DASHBOARD' || process.env.REACT_APP_ENVIROMENT_MODE === 'KPI' ? onHandleAlert() : changeGraph(false)}
                        disabled={loadingDashboardData}
                    >
                        <Speed/> 
                    </IconButton>
            ...
            >
                <IconButton 
                    size="small"
                    className={clsx(classes.actionIcon, {[classes.active]: props.dashboardScreen === true && viewDashboard.line && viewDashboard.jurisdictions == false && viewDashboard.invention === false && viewDashboard.sankey === false && viewDashboard.kpi === false && viewDashboard.timeline === false})}
                    onClick={() => process.env.REACT_APP_ENVIROMENT_MODE === 'DASHBOARD' || process.env.REACT_APP_ENVIROMENT_MODE === 'KPI' ? onHandleAlert() :  changeGraph(true)}
                >
                    <AutoGraph/>
                </IconButton> 
            </AddToolTip>
            ...
            >
                <IconButton 
                    ...
                    onClick={ process.env.REACT_APP_ENVIROMENT_MODE === 'DASHBOARD' || process.env.REACT_APP_ENVIROMENT_MODE === 'KPI' ? onHandleAlert : onHandleTimeline}
                >
                    <ViewTimeline/>
                </IconButton> 
            </AddToolTip>
                    ...
                    <React.Fragment>
                        ...
                        >
                            <IconButton 
                                ...
                                onClick={ process.env.REACT_APP_ENVIROMENT_MODE === 'DASHBOARD' || process.env.REACT_APP_ENVIROMENT_MODE === 'KPI' ? onHandleAlert : onHandleInvention}
                            >
                        ...
                        >
                            <IconButton 
                                ...
                                onClick={ process.env.REACT_APP_ENVIROMENT_MODE === 'DASHBOARD' || process.env.REACT_APP_ENVIROMENT_MODE === 'KPI' ? onHandleAlert : onHandleJurisdiction}
                            >
                                <Public/>
                            </IconButton>   
                        </AddToolTip>  
                        ...
                        >
                            <IconButton 
                                ...
                                onClick={ process.env.REACT_APP_ENVIROMENT_MODE === 'DASHBOARD' || process.env.REACT_APP_ENVIROMENT_MODE === 'KPI' ? onHandleAlert : onHandleSankey}
                            >
                        ...
                        >
                            <IconButton 
                                ...
                                onClick={ process.env.REACT_APP_ENVIROMENT_MODE === 'DASHBOARD' || process.env.REACT_APP_ENVIROMENT_MODE === 'KPI' ? onHandleAlert : onHandlePatentAssets}
                            >
                        ...
                        >
                            <IconButton 
                                ...
                                onClick={ process.env.REACT_APP_ENVIROMENT_MODE === 'DASHBOARD' || process.env.REACT_APP_ENVIROMENT_MODE === 'KPI' ? onHandleAlert : onHandleTransactions}
                            >
                        ...
                        >
                            <IconButton 
                                ...
                                onClick={ process.env.REACT_APP_ENVIROMENT_MODE === 'DASHBOARD' || process.env.REACT_APP_ENVIROMENT_MODE === 'KPI' ? onHandleAlert : onShare}
                            >
                                <FontAwesomeIcon
                                    icon={faShareAlt}
                                />
                        ...
                        <IconButton
                            ...
                            onClick={ process.env.REACT_APP_ENVIROMENT_MODE === 'DASHBOARD' || process.env.REACT_APP_ENVIROMENT_MODE === 'KPI' ? onHandleAlert : props.handleClipboard}
                            size="large">

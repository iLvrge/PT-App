...
export const controlList = [
    ...
    {
        type: 'menu',
        mainHeading: 'Assigned',
        subHeading: '',
        svg: '',
        image: `https://s3-us-west-1.amazonaws.com/static.patentrack.com/icons/menu/invent.png`,
        class: 'hex-6',
        breadCrumbs: 'KPI > Assigned',
        category: 'assigned',
        layout_id: 5,
        showSvg: false,
        mainHeadingClass: 'acquisition',
    ...
    },
    {
        ...
        image: `https://s3-us-west-1.amazonaws.com/static.patentrack.com/icons/menu/invent.png`,
        class: 'hex-6',
        breadCrumbs: 'KPI > Challenged (PTAB)',
        category: 'ptab',
        layout_id: 5,
        showSvg: false,
        mainHeadingClass: 'acquisition',
